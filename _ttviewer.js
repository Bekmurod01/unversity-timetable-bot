...
exports._hotswap = exports.showTTViewerDlg = exports.TTItemPopup = exports.TopButton = exports.TTViewer = void 0;
...
var popuppanel_1 = require("../react/popuppanel");
var maindbi_ui_1 = require("../rpr/maindbi_ui");
...
function TTViewer(props) {
    ...
    var log_module = 'TTViewer';
    var fitheight = props.fitheight, kiosk = props.kiosk;
    (0, asc_react_1.useTTLang)();
    var _c = React.useState((0, asc_react_1.useResponsiveLevel)()), compactLevel = _c[0], setCompactLevel = _c[1];
    var onOverflow = function () { return setCompactLevel(Math.min(2, compactLevel + 1)); };
    var _d = (0, asc_react_1.useClientWidth)(), width = _d[0], div_ref = _d[1];
    var prev_width = (0, asc_react_1.usePrevious)(width, 0);
    ...
    var _f = React.useState(props.date || (props.week && (0, lib_date_1.week_start)(req, props.week)) || today), date = _f[0], setDate = _f[1];
    var _g = React.useState(props.num ? 'regular' : 'current'), mode = _g[0], setMode = _g[1];
    var setShowCurrent = function () {
        setMode('current');
    };
    React.useEffect(function () {
        (0, maindbi_ui_1.maindbiActionStat)(log_module, 'timetables', 'show');
    }, []);
    ...
    var _m = (0, popuppanel_1.useSimplePopup)(), Popup = _m[0], showPopup = _m[1], popupShown = _m[2];
    var onTTItemClick = function (ti, e) {
        setSelectedTTItem(ti);
        showPopup(e);
        (0, maindbi_ui_1.maindbiActionStat)(log_module + '.onTTItemClick', 'timetables', 'click');
    };
    var _o = React.useState(), subtoolbar = _o[0], setSubtoolbar = _o[1];
    var _p = React.useState(null), dbi = _p[0], setDbi = _p[1];
    var _q = React.useState({}), rights = _q[0], setRights = _q[1];
    var week = (0, lib_date_1.date_week)(req, date);
    var this_week = (0, lib_date_1.date_week)(req, today);
    var min_week = (0, lib_date_1.week_delta)(req, this_week, -2);
    if (req.isAdmin() || (req.isUcitel() && !req.hasRight('limited')))
        min_week = '';
    var datefrom = (0, lib_date_1.week_start)(req, week);
    var dateto = (0, lib_date_1.week_end)(req, week);
    var year = req.getSchoolYear(date);
    var datefrom_inyear = (0, dbi_1.strMax)(datefrom, req.schoolYear_turnOver(year));
    var dateto_inyear = (0, dbi_1.strMin)(dateto, req.schoolYear_turnOver_end(year));
    var data = (0, asc_react_1.useAsyncMemo)(function () { return (0, ttviewer_1.getTTViewerData)(null, year); }, [year], null, { interactive: false });
    var _r = (0, asc_react_1.useLocalState)('CurrentTTViewer.showColor', data ? data.defaults.showColors : true), showColors = _r[0], setShowColors = _r[1];
    var _s = React.useState(true), showOrig = _s[0], setShowOrig = _s[1];
    var _t = React.useState(false), showIgroupsInClasses = _t[0], setShowIgroupsInClasses = _t[1];
    var _u = useStateWithDefault((_a = data === null || data === void 0 ? void 0 : data.defaults.timeMode) !== null && _a !== void 0 ? _a : false), timeMode = _u[0], setTimeMode = _u[1];
    var _v = useStateWithDefault((_b = data === null || data === void 0 ? void 0 : data.defaults.swapAxis) !== null && _b !== void 0 ? _b : false), swapAxis = _v[0], setSwapAxis = _v[1];
    var _w = (0, asc_react_1.useLocalState)('CurrentTTViewer.fit', false, { where: 'localStorage' }), fit = _w[0], setFit = _w[1];
    var _x = React.useState(true), colorsEnabledInRegular = _x[0], setColorsEnabledInRegular = _x[1];
    var _y = React.useState(false), disableColorsInRegular = _y[0], setDisableColorsInRegular = _y[1];
    React.useEffect(function () {
        if (fitheight)
            barWndResize();
    }, [data]);
    ...
    if (user) {
        if (menu.length)
            menu.push([]);
        menu.push({
            text: (0, actions_1.action_name)('print'),
    ...
    if (req.hasRight('timetable')) {
        var submenu = tslib_1.__spreadArray([], settings_menu, true);
        submenu.push([]);
        submenu.push({
            text: req.ls(1687),
    ...
    if ((req.isAdmin() || req.isUcitel())) {
        ...
        if (help_1) {
            menu.push([]);
            menu.push({
                text: (0, actions_1.action_name)('help'),
    ...
    if (mode == 'regular' && dbi) {
        ...
        for (var _i = 0, _z = ['classes', 'teachers', 'classrooms']; _i < _z.length; _i++) {
            var t = _z[_i];
            _loop_1(t);
        }
    }
    ...
    if (week != this_week) {
        week_menu.push({
            text: req.ls(1733),
            onClick: function () { return setDate((0, lib_date_1.week_start)(req, this_week)); }
        });
    }
        ...
        if (mode == 'regular') {
            return React.createElement(regulartt_1.RegularTTView, { tt_num: tt_num, oblast: oblast, id: userRow.id, disableColors: disableColorsInRegular, mode: regularMode, fixTTColors: fixTTColors, style: {
                    ...
                    : function (menu) {
                        if (!subtoolbar)
                            return undefined;
                        return (0, react_dom_1.createPortal)(menu.map(function (item, i) {
                    ...
                    }, setViewData: print ? undefined : setViewData, onTTItemClick: print ? undefined : onTTItemClick, selectedTTItem: print ? undefined : selectedTTItem });
        }
        else {
            return React.createElement(currenttt_1.CurrentTTView, { table: userRow.table, id: userRow.id, year: year, datefrom: datefrom, dateto: dateto, showColors: showColors, showIgroupsInClasses: showIgroupsInClasses, showOrig: showOrig, showCurrentTime: !print, showHeader: true, time_mode: timeMode, swapAxis: swapAxis, fit: fit && !print, onTTItemClick: print ? undefined : onTTItemClick, selectedTTItem: (popupShown && !print) ? selectedTTItem : undefined, setViewData: print ? undefined : setViewData, fixTTColors: fixTTColors, style: print
                    ? undefined
                    : {
                        flex: '1 1 0px',
                        minWidth: 100,
    ...
    return React.createElement("div", { ref: div_ref, id: fitheight ? 'fitheight' : undefined, style: tslib_1.__assign({ display: 'flex', flexDirection: 'column', boxSizing: 'border-box', minHeight: 100, height: compactLevel == 0 ? '80vh' : (fitheight ? 300 : 650), background: '#ffffff' }, props.style || {}) },
        React.createElement("div", { style: {
            ...
            dbi && tables.map(function (t) {
                ...
                var item2menuItem = function (id, suffix) {
                    ...
                    return {
                        text: ASC.escapeHTML(dbi.rowName(t, row.id, req.sort_name_col + 'u') + (suffix || '')),
                ...
                if (t == 'students') {
                    ...
                    var srows = tslib_1.__spreadArray([], rows, true);
            ...
            req.hasRight('timetable') && compactLevel == 0 && React.createElement(React.Fragment, null,
                ...
                React.createElement(TopButton, { text: (0, actions_1.action_name)('customize'), icon: '/global/pics/ui/tools.svg', menu: tslib_1.__spreadArray([], settings_menu, true) }),
            ...
            mode == 'regular'
                ? React.createElement(React.Fragment, null,
                    React.createElement(TopButton, { text: regular_tt && regular_tt.hidden ? regular_tt.text : req.ls(8735), style: right_style, menu: kiosk
                            ? undefined
                            : tslib_1.__spreadArray(tslib_1.__spreadArray(tslib_1.__spreadArray([], data.regular.timetables.filter(function (tt) { return !tt.hidden; }).map(function (tt) {
                                return {
                                    text: tt.text,
                                ...
                                : [], true), enabled: true }))
                : React.createElement(React.Fragment, null,
                    week > min_week && React.createElement(TopButton, { text: compactLevel == 0 ? '<<' : '<', style: right_style, onClick: function () { return setDate((0, lib_date_1.date_delta)(datefrom_inyear, -1)); } }),
                    React.createElement(TopButton, { text: week == this_week ? req.ls(1733) : (0, lib_date_1.date_format_2dates)(req, datefrom_inyear, dateto_inyear, compactLevel == 0), style: right_style, menu: week_menu, enabled: true }),
                    React.createElement(TopButton, { text: compactLevel == 0 ? '>>' : '>', style: right_style, onClick: function () { return setDate((0, lib_date_1.date_delta)(dateto_inyear, +1)); } })),
        ...
        React.createElement("div", { style: {
            ...
            selectedTTItem && popupShown && React.createElement(Popup, { appMode: 'rdialog' },
                React.createElement(TTItemPopup, { ttitem: selectedTTItem, dbi: dbi, style: {
                        width: 250,
                        marginRight: 10,
                    } }))));
}
exports.TTViewer = TTViewer;
TTViewer.needed_part = (0, dbi_1.typed)({
...
function TopButton(props) {
    var _a = (0, asc_react_1.useHoverWithMenu)(), isHovering = _a[0], hoverProps = _a[1], showMenu = _a[2];
    ...
    if (enabled == undefined)
        enabled = clickable;
    (0, asc_react_1.useDomReader)(function () {
...
function TTItemPopup(props) {
    var ttitem = props.ttitem, dbi = props.dbi;
    var req = edurequest_1.client_req;
    ...
    return React.createElement(popuppanel_1.PopupWithHeader, { title: title, icon: icon },
        React.createElement("div", { style: {
                padding: props.addPadding ? '0px 10px 10px 10px' : undefined,
            } },
            React.createElement(Field, null, (0, lib_date_1.date_format_day)(req, date, false)),
            ttitem.starttime && React.createElement(Field, null, (0, lib_date_1.date_format_time0)(req, ttitem.starttime, { ajSekundy: false })
                + '-'
                + (0, lib_date_1.date_format_time0)(req, ttitem.endtime, { ajSekundy: false })),
            React.createElement(asc_react_1.VGap, { height: 15 }),
            dpRow
                ? React.createElement(React.Fragment, null, (0, asc_react_1.wrapSuspense)(React.createElement(RDpRow, { dpRow: dpRow, dbi: dbi, date: date, mode: 'ttviewer' })))
                : React.createElement(React.Fragment, null,
...
exports.TTItemPopup = TTItemPopup;
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    (_a.sent()).showTimetableViewRightsDlg();
                    return [2];
            }
        });
    });
...
function ChooseRegularTTDlg(props) {
    var req = (0, asc_react_1.useReq)();
    var dbi = (0, dbi_react_1.useMainDBI)(req.getSchoolYear(), {
        needed_part: {
            timetables: [
                'stav',
                'name',
    ...
    var selectedIdRef = (0, asc_react_1.useStateValueRef)('');
