...
def main_menu_keyboard() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="🔔 Notifications"), KeyboardButton(text="📊 Exams / Deadlines")],
            [KeyboardButton(text="🏫 Room Finder"), KeyboardButton(text="⚙️ Settings")],
        ],
...
def day_picker_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        keyboard=[[KeyboardButton(text=day)] for day in days] + [[KeyboardButton(text="⬅️ Back")]],
        resize_keyboard=True,
    )
...
def teacher_menu_keyboard() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="🔍 Search Teacher"), KeyboardButton(text="⭐ Favorite Teachers")],
            [KeyboardButton(text="📋 All Teachers"), KeyboardButton(text="🕒 Recent Searches")],
            [KeyboardButton(text="⬅️ Back")],
        ],
        resize_keyboard=True,
    )
